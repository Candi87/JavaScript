...
return `Hola mi nombre es ${name} ${surname} como esta`;
} */

const sayHello = (callback) => alert(callback('Nacho', 'RS'));

sayHello((name, surname) => `Hola mi nombre es ${name} ${surname} como esta`);
